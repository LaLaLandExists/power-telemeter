...
// On-air duration of an 8-byte BeaconPacket at SF7 / 125 kHz / CR 4:5,
// 8-symbol preamble, explicit header, CRC enabled.
// Ts = 2^7/125000 = 1.024 ms; ToA = (12.25 + 23) × 1.024 = 36.096 ms → 36 ms.
