 ...
 * via MB85RC256V FRAM (32 KB, I2C) using the robtillaart/FRAM_I2C library.
 *
 ...
 *             +48  history[120] (1920 bytes, 120 x 16 bytes each)
 *   0x07C0  Node[1] block ...
 *   ...
 *   Total: 16 + 8x1968 = 15 760 bytes  (<32 768 bytes)
 *
 * Write policy
 * ------------
...
/**
 * Initialise I2C bus and verify FRAM is reachable.
