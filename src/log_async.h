...
// --- Log-line relay (WebSocket) -----------------------------------------------
#define LOG_LINE_MAX   96u   // max relay line length (null-terminated)
#define LOG_LINE_DEPTH 24u   // relay queue depth (~2.3 KB heap)

/** Pop one complete log line into buf. Returns false if the queue is empty. */
